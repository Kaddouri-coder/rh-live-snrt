          ...
          <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                className="px-2.5 py-1 text-xs font-medium bg-white hover:bg-emerald-50 hover:text-emerald-700 text-slate-700 border border-slate-300 rounded-lg shadow-2xs transition-colors flex items-center gap-1"
              >
                <CheckSquare className="w-3.5 h-3.5 text-emerald-600" /> Tout sélectionner
              </button>
              <button
                type="button"
                onClick={handleDeselectAll}
                className="px-2.5 py-1 text-xs font-medium bg-white hover:bg-rose-50 hover:text-rose-700 text-slate-700 border border-slate-300 rounded-lg shadow-2xs transition-colors flex items-center gap-1"
              >
                <Square className="w-3.5 h-3.5 text-rose-500" /> Tout désélectionner
              </button>
              <button
                type="button"
                onClick={handleSelectTechnique}
                className="px-2.5 py-1 text-xs font-medium bg-white hover:bg-slate-100 text-slate-700 border border-slate-300 rounded-lg shadow-2xs transition-colors"
              >
                🎥 Équipe Technique
              </button>
              <button
