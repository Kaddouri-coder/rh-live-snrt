    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white rounded-2xl p-6 shadow-md border border-slate-800 relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <span className="text-[11px] font-bold text-emerald-400 bg-emerald-950/80 border border-emerald-800 px-2.5 py-0.5 rounded-full uppercase tracking-wider">
              Période active
            </span>
            <h2 className="text-lg md:text-xl font-bold mt-2">
              Statut de la disponibilité des Ressources Humaines
            </h2>
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold px-4 py-2 rounded-lg shadow transition-colors flex items-center space-x-2"
            >
              <Search className="w-4 h-4" />
              <span>Consulter Disponibilités</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-emerald-50/60 rounded-xl p-4 border border-emerald-200 shadow-sm flex items-center justify-between">
          <div>
        ...
        <div className="bg-rose-50/60 rounded-xl p-4 border border-rose-200 shadow-sm flex items-center justify-between">
          <div>
          ...
          <div className="w-12 h-12 rounded-xl bg-rose-600 flex items-center justify-center text-white shadow-sm">
      ...
      <div className="bg-gradient-to-br from-emerald-900/5 to-teal-900/5 rounded-xl border border-emerald-200/80 p-4">
